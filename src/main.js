          ...
          mobileMenu.innerHTML = `
            ...
            <div class="py-4">
              <div class="grid grid-cols-2 gap-4 px-4">
                ...
                ${isAuthenticated ? `
                <a href="/src/manage/manage.html" class="flex flex-col items-center space-y-2 p-3 hover:bg-gray-800 rounded-lg" onclick="window.location.href='/src/manage/manage.html'; this.closest('#mobileMenuOverlay').remove();">
                  <svg class="w-8 h-8 text-crisp-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
